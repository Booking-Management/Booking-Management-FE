...
export default function Footer() {
  return (
    <div className="mt-8 bg-slate-800 pt-9">
      <div className="mx-auto w-full lg:w-9/12 px-4 xl:px-0">
        <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
          ...
          <div className="mt-6 flex w-full flex-col justify-between text-white sm:flex-row md:mt-0 md:max-w-[341px]">
            <div>
              <p className="text-deutziawhite  text-[18px] font-medium leading-normal">
                Pages
              </p>
              <ul>
            ...
            <div className="mt-6 flex flex-col gap-4 sm:mt-0">
              <p className="text-deutziawhite  text-[18px] font-medium">
                Download the app
              </p>
        ...
        <div className="flex items-center justify-center pb-8 pt-[9px] md:py-8">
          <p className="text-[10px] text-white md:text-[12px]">
            © Copyright
            {/* */}2024
